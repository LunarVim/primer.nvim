...
theme.set_highlights = function()
  ...
  hl(0, "DiffText", { fg = c.alt_bg, bg = c.dark_red })
  ...
  hl(0, "TabLineSel", { fg = c.fg, bg = c.alt_bg })
  ...
  hl(0, "PreProc", { fg = c.light_red, bg = 'NONE' })
  ...
  hl(0, "MatchParen", { fg = c.hint, bg = 'NONE' })
  hl(0, "MatchParenCur", { fg = 'NONE', bg = 'NONE' })
