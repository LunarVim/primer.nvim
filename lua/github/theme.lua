...
theme.set_highlights = function()
  ...
  hl(0, "MsgArea", { fg = c.comment, bg = 'NONE' })
  hl(0, "ModeMsg", { fg = c.comment, bg = 'NONE', bold=true, })
  ...
  hl(0, "MatchParen", { fg = 'NONE', bg = c.teal, bold=true, })
  ...
  hl(0, "NvimTreeVertSplit", { fg = c.fg, bg = c.fg_dark })
  ...
  -- IndentBlankline
  hl(0, "IndentBlanklineContextChar", { fg = '#6e7681', bg = 'NONE' })
